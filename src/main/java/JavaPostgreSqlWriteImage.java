...
and database name is mahendra. */
            String connectionURL = "jdbc:postgresql://localhost:5432/house";
...
connect to database. */
                connection = DriverManager.getConnection(connectionURL, "wecode", "de los cobos");
// create a file object for image by specifying full path of image as parameter.
                File image = new File("C:/Luxury-Homes-in-Africa.jpg");
